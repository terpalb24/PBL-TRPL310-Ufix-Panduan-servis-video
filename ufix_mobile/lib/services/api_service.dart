...
class ApiService {
  ...
  static Future<Map<String, dynamic>> getNewVideos() async {
    try {
      ...
      print('[getNewVideos] Status: ${response.statusCode}');
      print('[getNewVideos] Response: $result');
      if (result['videos'] != null && (result['videos'] as List).isNotEmpty) {
        print('[getNewVideos] First video: ${result['videos'][0]}');
      }
      return result;
    } catch (e) {
      print('[getNewVideos] Error: $e');
      return {'success': false, 'message': 'Network error: $e'};
    }
  }
