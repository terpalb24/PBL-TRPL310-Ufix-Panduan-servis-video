...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  Future<void> _initializeVideo() async {
    try {
      ...
      print('[Video Init] Full response: $streamResponse');
      ...
      if (streamResponse['success'] == true) {
        ...
        print('✅ Video type: ${videoData.runtimeType}');
        print('✅ Video data keys: ${videoData.keys}');
        print('Video details: ${videoData['judul']}');

        _mediaPlayer = Player();
        _videoController = media_kit.VideoController(_mediaPlayer!);
        
        print('[Video Init] Opening media with URL: $videoUrl');
        await _mediaPlayer!.open(Media(videoUrl));
        print('[Video Init] Media opened successfully');
